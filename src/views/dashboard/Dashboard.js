...
const Dashboard = () => {
  ...
  const gerEmpDetails = () => {
    ...
    // .then((res) => {
    //   if (res.type === 'get-employee/details/fulfilled') {
    //     //setEmpInfo(res.payload)
    //   }
    // })
              ...
              <CChartPie
                data={{
                  ...
                  datasets: [
                    {
                      data: [
                        leaveChart?.data[0]?.casual_leave,
                        leaveChart?.data[0]?.earn_leave,
                        leaveChart?.data[0]?.sick_leave,
                      ],
